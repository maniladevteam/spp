...
public class SppWgRaw extends HttpServlet {
       ...
       protected void doGet(HttpServletRequest request,
    	   	...
    	   	String param_workgroup = request.getParameter("param_workgroup");
             ...
             try {
        			...
        			String sql = "call spp.spp_rawdata_wg_download(?,?,?,?,?)";
                    ...
                    WritableCellFormat cellFormat = new jxl.write.WritableCellFormat(new jxl.write.DateFormat("MM/dd/yyyy hh:mm"));
                    ...
                    Logger.getLogger(SppWgRaw.class.getName()).log(Level.SEVERE,
                                 null, ex);
				...
				e.printStackTrace();
                    ...
                    try {
                           ...
                           Logger.getLogger(SppWgRaw.class.getName()).log(
