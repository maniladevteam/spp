...
<input type="hidden" id="agent_tm" disabled="disabled" value=""/> 
<input type="hidden" id="agent_wg" disabled="disabled" value=""/> 
				            ...
				            <div class="col-lg-4">
				                <div class="hpanel stats">
				                    ...
				                    <div class="panel-body h-200">
				                        ...
				                        <div class="clearfix"></div>
				                        <div class="flot-chart">
				                            <div class="flot-chart-content" id="cmoverallscorechart_box_modalwg">
				                            	
				                            </div>                            
				                        </div>
				                        <div class="m-t-xxl">
				                           <div class="row p-b-n-lg" id="cmoverallscore_box_modalwg">
            ...
            <div class="col-lg-3">
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200">
                        ...
                        <div class="clearfix"></div>
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="teamscorechart_box_modalwg">
                            	
                            </div>                            
                        </div>
                        <div class="m-t-xxl">
                           <div class="row m-t .p-b-n-lg" id="teamscore_box_modalwg">
                   
                            </div>
                        </div>
                    </div>
                    <div class="panel-footer">
                        Group Scores by Team Manager
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200">
                        ...
                        <div class="clearfix"></div>
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="workgroupscorechart_box_modalwg">
                            	
                            </div>                            
                        </div>
                        <div class="m-t-xxl">
                           <div class="row m-t .p-b-n-lg" id="workgroupscore_box_modalwg">
                   
                            </div>
                        </div>
                    </div>
                    <div class="panel-footer">
                        Group Scores by Workgroup
                    </div>
                </div>
            </div>
...
<script src="modules/scoregenag.js"></script>
