...
<aside id="menu">
    <div id="navigation">
        ...
        <ul class="nav" id="side-menu">
            <li class="active">
                 <a><span class="nav-label">Dashboard</span> <span class="label label-success pull-right">v.1</span></a>
            </li>
            <li >
				            ...
				            <div class="col-lg-4">
				                <div class="hpanel stats">
				                    ...
				                    <div class="panel-body h-200">
				                        ...
				                        <div class="m-t-lg">
				                           <div class="row m-t-lg .p-b-n-lg" id="overeallscore_box">
            ...
            <div class="col-lg-3">
                <div class="hpanel" id="functionscore">
                    <div class="panel-body list">
                    	...
                    	<div class="row">
                    		<div class="panel-title m-l" id="prodlc_listtitle"><h3>Agent List</h3></div>
                    	</div> 
