...
$(document).ready(function() {
					...
					$("#extractrawdatabut").click(function() {	
							...
							GetSppRawData($("#filter_view_rawmodal").val(), $("#freqno_rawmodal").val(), $("#yearno_rawmodal").val(), $("#uidlogged").val());
...
function GetUserInfo(param_userid) {
	...
	$.ajax({
		...
		success : function(response) {
			...
			GetUserAuditLog($("#uidlogged").val(), $("#user_role").text(), "agent page", $("#user_name").text(),'');
		}
...
function GetAgentInfo(param_userid) {

	var i = 0;
	
	$.ajax({
		type : "POST",
		url : "spp-admin/action-spp/agentinfo",
		data : "{\"param_userid\":" + '"' + param_userid + '"}',
		contentType : "application/x-www-form-urlencoded",
		dataType : "json",
		success : function(response) {
			...
			var dataTable2 = "";
				...
				agent_tm = resultsArray[0].tm_id;
				agent_wg = resultsArray[0].workgroup;
...
function RunScore(param_view, param_yearno){
		...
		GetAgSppScore($("#filter_view").val(), $("#freqno").val(), $("#yearno").val(), $("#uidlogged").val());
		GetDetractSupportAgSppScore($("#filter_view").val(), $("#freqno").val(), $("#yearno").val(), $("#uidlogged").val());						
		GetFactorBucketsAgSppScore($("#filter_view").val(), $("#freqno").val(), $("#yearno").val(), $("#uidlogged").val());
		GetAgScore_TimeBucket($("#filter_view").val(), $("#freqno").val(), $("#yearno").val(), $("#uidlogged").val());
		GetAgSppScore_list($("#filter_view").val(), $("#freqno").val(), $("#yearno").val(), $("#uidlogged").val());
		GetOverallSppScore($("#filter_view").val(), $("#freqno").val(), $("#yearno").val());
		GetSppCmWgScore($("#filter_view").val(), GetWorkgroupFunctions(agent_wg), $("#freqno").val(), $("#yearno").val());
		GetTmSppScore($("#filter_view").val(), $("#freqno").val(), $("#yearno").val(), agent_tm);
		GetWgSppScore($("#filter_view").val(), $("#freqno").val(), $("#yearno").val(), agent_wg);
...
function GetAgSppScore(param_view, param_freqno, param_yearno, param_empid) {
	...
	GetAgSppScore_Cur(param_view, param_freqno, param_yearno, param_empid);

	function GetAgSppScore_Cur(param_view, param_freqno, param_yearno, param_empid) {
		...
		$.ajax({
			type : "POST",
			url : "spp-admin/action-spp/sppscoreag",
			data : "{\"param_view\":" + '"' + SelectView(param_view,1)
			...
			complete : function(e) {
				...
				GetAgSppScore_Pre(param_view, previous_freqno,param_yearno, param_empid)
			}

		});
	}

	function GetAgSppScore_Pre(param_view, param_freqno, param_yearno, param_empid) {
		...
		$.ajax({
			...
			success : function(response) {
				...
				RenderAgSppScore()
				GetAgSppScore_Chart_Cur(param_view, param_freqno, param_yearno, param_empid)
			}

		});
	}
	
	function GetAgSppScore_Chart_Cur(param_view, param_freqno, param_yearno, param_empid) {
		...
		$.ajax({
			...
			complete : function(e) {
				 RenderChartJsData();
				 GetGamefySpScore(param_view, param_freqno, param_yearno, param_empid);
			}
	...
	function GetGamefySpScore(param_view, param_freqno, param_yearno, param_empid) {
...
function GetDetractSupportAgSppScore(param_view, param_freqno, param_yearno, param_empid){
	...
	GetDetractSupportSpp(param_view, param_freqno, param_yearno, param_empid);

	function GetDetractSupportSpp(param_view, param_freqno, param_yearno, param_empid) {

		var i = 0;

		$.ajax({
					type : "POST",
					url : "spp-admin/action-spp/sppscoredetractsupportag",
					data : "{\"param_view\":" + '"' + SelectView(param_view,1)
							+ "\",\"param_freqno\":" + '"' + param_freqno
							+ "\",\"param_empid\":" + '"' + param_empid
							+ "\",\"param_yearno\":" + '"' + param_yearno + '"}',
...
function GetFactorBucketsAgSppScore(param_view, param_freqno, param_yearno, param_empid){
	...
	GetFactorBucketsSpp(param_view, param_freqno, param_yearno, param_empid);

	function GetFactorBucketsSpp(param_view, param_freqno, param_yearno, param_empid) {
		...
		$.ajax({
					type : "POST",
					url : "spp-admin/action-spp/sppscorefactorbucketsag",
					data : "{\"param_view\":" + '"' + SelectView(param_view,1)
							+ "\",\"param_freqno\":" + '"' + param_freqno
							+ "\",\"param_empid\":" + '"' + param_empid
							+ "\",\"param_yearno\":" + '"' + param_yearno + '"}',
...
function GetAgScore_TimeBucket(param_view, param_freqno, param_yearno, param_empid) {
	...
	GetSppTimeBucket_List(param_view, param_freqno, param_yearno, param_empid);

	function GetSppTimeBucket_List(param_view, param_freqno, param_yearno, param_empid) {

		var i = 0;

		$.ajax({
					type : "POST",
					url : "spp-admin/action-spp/sppscoretmagittimebucket",
					data : "{\"param_view\":" + '"' + SelectView(param_view,1)
							+ "\",\"param_freqno\":" + '"' + param_freqno
							+ "\",\"param_yearno\":" + '"' + param_yearno
							+ "\",\"param_empid\":" + '"' + param_empid + '"}',
	...
	function RenderSppScoreTimeBucket() {
		...
		dataTable = dataTable + "<th style='width: 100px; text-align:center'>Issue Type</th>"
...
function GetAgSppScore_list(param_view, param_freqno, param_yearno, param_empid) {
	...
	GetSppScore_Cur(param_view, param_freqno, param_yearno, param_empid);

	function GetSppScore_Cur(param_view, param_freqno, param_yearno, param_empid) {
		...
		$.ajax({
			type : "POST",
			url : "spp-admin/action-spp/sppscoreagitlist",
			data : "{\"param_view\":" + '"' + SelectView(param_view,1)
					+ "\",\"param_freqno\":" + '"' + param_freqno
					+ "\",\"param_yearno\":" + '"' + param_yearno
					+ "\",\"param_empid\":" + '"' + param_empid
			...
			complete : function(e) {
				...
				GetSppScore_Pre(param_view, previous_freqno, param_yearno, param_empid);
	...
	function GetSppScore_Pre(param_view, param_freqno, param_yearno, param_empid) {
	...
	function RenderSppScore() {
		...
		for (var i = 0; i < rownum; i++) {
			...
			dataTable = dataTable + "<div class='list-item' onclick='RunScoreWg(\""+ issue_type[i] +"\")'>"
			dataTable = dataTable + "<div class='row'>"
			dataTable = dataTable + "<div class='col-xs-5 fnxlist_margin_ovrd'>"
			dataTable = dataTable + "<a href='#'><h4 class='no-margins font-bold text-color3'>"+ issue_type[i] + "</h4></a>"
			dataTable = dataTable + "</div>"
...
function GetTmSppScore(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function GetWgSppScore_Cur(param_view, param_freqno, param_yearno, param_workgroup) {
		...
		$.ajax({
			type : "POST",
			url : "spp-admin/action-spp/sppscoretm",
			data : "{\"param_view\":" + '"' + SelectView(param_view,1)
					+ "\",\"param_freqno\":" + '"' + param_freqno
	...
	function RenderChartJsData (){
		...
		$("#teamscorechart_box_modalwg").html("");
		var myNewChart = "";
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='teamscorechart_modalwg' height='80'></canvas>";		    
		    $("#teamscorechart_box_modalwg").append(dataTable);
		  
		    var ctx = document.getElementById("teamscorechart_modalwg").getContext("2d");
		    myNewChart = new Chart(ctx).Line(lineData, lineOptions);		    	
	}

	function RenderWgSppScore() {

		$("#teamscore_box_modalwg").html("");
		...
		dataTable = dataTable + "<div class='col-md-6 m-t-xs m-l-md'><h4 >" + (pre_tp4allscore * 100).toFixed(0) + " <i class='fa " + ArrowUpDown((tp4allscore * 100).toFixed(0),(pre_tp4allscore * 100).toFixed(0), 1) + " " + ArrowUpDown((tp4allscore * 100).toFixed(0), (pre_tp4allscore * 100).toFixed(0), 2) + "'></i></h4></div>";
		dataTable = dataTable + "</div></div>"
		$("#teamscore_box_modalwg").append(dataTable);
...
function GetWgSppScore(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='workgroupscorechart_modalwg' height='80'></canvas>";		    
		    $("#workgroupscorechart_box_modalwg").append(dataTable);
		  
		    var ctx = document.getElementById("workgroupscorechart_modalwg").getContext("2d");
		    myNewChart = new Chart(ctx).Line(lineData, lineOptions);		    	
	}

	function RenderWgSppScore() {

		$("#workgroupscore_box_modalwg").html("");
		...
		dataTable = dataTable + "<div class='col-md-6 m-t-xs m-l-md'><h4 >" + (pre_tp4allscore * 100).toFixed(0) + " <i class='fa " + ArrowUpDown((tp4allscore * 100).toFixed(0),(pre_tp4allscore * 100).toFixed(0), 1) + " " + ArrowUpDown((tp4allscore * 100).toFixed(0), (pre_tp4allscore * 100).toFixed(0), 2) + "'></i></h4></div>";
		dataTable = dataTable + "</div></div>"
		$("#workgroupscore_box_modalwg").append(dataTable);
...
function GetSppCmWgScore(param_view, param_prodfam, param_freqno, param_yearno) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='cmoverallscorechart_modalwg' height='80'></canvas>";		    
...
function GetSppRawData(param_view, param_freqno, param_yearno, param_empid) {
	$("#preloadcube").show();
	$("#rawdatabody").html("");	
	...
	$.ajax({
		type : "POST",
		url : "spp-admin/action-spp/sppscoreagrawdata",
		data : "{\"param_view\":" + '"' + SelectView(param_view,1)
				+ "\",\"param_freqno\":" + '"' + param_freqno
				+ "\",\"param_yearno\":" + '"' + param_yearno
				+ "\",\"param_empid\":" + '"' + param_empid
