...
<head>
	...
	<link href="styles/font_icons8.css" rel="stylesheet">
                    ...
                    <div class="panel-body" id="mainscorebox">
                        <div class="row">
                            <div class="col-md-3 text-center">                            	
								...
								<div class="row m-t-sm m-l-md" id="overeallscore_box"></div>
								<div class="row">
			                        <div class="stats-title text-center m-l-md">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="flot-chart" id="overallscorechart_box"  style="height: 160px">
            ...
            <div class="col-lg-3">
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200">
                        ...
                        <div class="flot-chart" id="prodfamilychart_box">
                            
                        </div>
                        <div class="m-t-xs">
                            <div class="row m-t-lg .p-b-n-lg " id="prodfam_box"></div>
                        </div>
                    </div>
	                    	...
	                    	<div class="pull-right m-b-lg m-r-md">
	                            <div data-toggle="buttons" class="btn-group">
		                            <label class="btn btn-success active btn-xs">
		                                <input type="radio" id="prodlc_radio1" value="prodfam" name="prodlc_radio"> Product Family
		                            </label>
		                            <label class="btn btn-success btn-xs">
		                                <input type="radio" id="prodlc_radio2" value="languagectr" name="prodlc_radio"> Language Center
		                            </label>
		                            <label class="btn btn-success btn-xs">
		                                <input type="radio" id="prodlc_radio2" value="specialist" name="prodlc_radio"> Specialist
		                            </label>                           
	                        	</div>
	                        </div>
                    	</div>
                    	<div class="row">
                    		<div class="panel-title m-l" id="prodlc_listtitle"><h3>Product Family</h3></div>
                    	</div> 
            ...
            <div class="col-lg-3">
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200">
                        ...
                        <div class="clearfix"></div>
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="languagectrchart_box">
                            	
                            </div>                            
                        </div>
                        <div class="m-t-xs">
                           <div class="row m-t-lg .p-b-n-lg" id="languagectr_box">
            ...
            <div class="col-lg-3">
                <div class="hpanel stats">
                    <div class="panel-body h-200">
                        ...
                        <div class="clearfix"></div>
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="specialistchart_box">
                            
                            </div>
                        </div>
                        <div class="m-t-xs">

                            <div class="row m-t-lg .p-b-n-lg" id="specialist_box"></div>
                        </div>
                    </div>
                    <div class="panel-footer">
				                    ...
				                    <div class="panel-body">
				                        <div class="row">
				                            <div class="col-md-3 text-center">                            	
												...
												<div class="row">
							                        <div class="stats-title text-center m-l-md">
					                            		<span id="prodlc_totalsurveys"></span>
					                        		</div>
						                        </div>                        	                                
				                            </div>
				                            <div class="col-md-9">
...
<script src="modules/scoregen.js"></script>
