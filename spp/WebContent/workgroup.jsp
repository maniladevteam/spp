...
<head>
	...
	<link rel="stylesheet" href="styles/scorejs.css">
...
<div class="splash"> <div class="color-line"></div><div class="splash-title"><h1>Service Pulse Portal</h1><p>Loading Application Resources </p><div class="spinner"> <div class="rect1"></div> <div class="rect2"></div> <div class="rect3"></div> <div class="rect4"></div> <div class="rect5"></div> </div> </div> </div>
<!--[if lt IE 7]>
    ...
    <div id="navigation">
        <div class="profile-picture" id="userprofile">
            ...
            <div class="stats-label text-color">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                        <small class="text-muted"><span id="user_role">TR Admin</span><b class="caret"></b></small>
                    </a>
        ...
        <ul class="nav" id="side-menu">
            ...
            <li >
                <a href="#" ><span class="nav-label" id="crossmodularbut">Cross Modular</span></a>
            </li>
            <li>
            ...
            <li id="filters">
                ...
                <ul class="nav nav-second-level">
                	<li>
                		<label class='col-sm-2 control-label m-t'>Grouping</label>
                		<div class='col-sm-10 '>
	                		<select class="form-control m-b" name="grouping_view" id="grouping_view">
				                <option value="tm">Team</option>
				                <option value="wg">Workgroup</option>				                
				            </select>
			            </div>
			        </li>
                	
                	<li id="filter_wg">
                		<label class='col-sm-2 control-label m-t'>Workgroup</label>
                		<div class='col-sm-10 '>
	                		<select class="form-control m-b" name="workgroup_select" id="workgroup_select"></select>
			            </div>
			        </li>
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="hpanel">                    
                    ...
                    <div class="panel-footer" id="updatedate">
            ...
            <div class="col-lg-3">
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200">
                        ...
                        <div class="flot-chart" id="overallscorechart_box">
                            
                        </div>
                        <div class="m-t-xs">
                            <div class="row m-t-lg .p-b-n-lg " id="overeallscore_box"></div>
                        </div>
                    </div>
                    <div class="panel-footer">
                        Overall Helpdesk Service Pulse Score
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
		                ...
		                <div class="hpanel stats" id="scorebreakdownscore">		                
		                    <div class="panel-body piechart_box">
		                        ...
		                        <div class="flot-chart">
		                            <div class="flot-chart-content" id="satsurveybreakdown_box_wg">
		                    ...
		                    <div class="panel-footer contact-footer" id="detractsupport_tab_wg">
				            ...
				            <div class="panel-body">
				                <div class="table-responsive">
					                <h4>Timeliness Buckets</h4>
				               		<table id='tp2timebucket_wg' class="table table-striped dt_rowpaddinfg hover cell-border row-border"></table>
								</div>				
				            </div>
				            <div class="panel-footer">
            ...
            <div class="col-lg-3">
                <div class="hpanel" id="functionscore">
                    ...
                    <div class="panel-body list">
                        <div class="panel-title" id="prodlc_listtitle"><h3>Agent List</h3></div>
                        <small class="fo">Service Pulse Score by Functions</small>
                        <div class="list-group" id="agent_list"></div>
            ...
            <div class="col-lg-3">
                <div class="hpanel stats" >
                    ...
                    <div class="panel-body h-200">
                        <div class="stats-title pull-left">
                            <h3><span id ='rightbox_fxngroup'><span></span></h3>
                        </div>
                        <div class="stats-icon pull-right">
                            <i class="pe-7s-folder fa-4x"></i>
                        </div>
                        <div class="clearfix"></div>
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="prodlcgroupchart_box">
                            	
                            </div>                            
                        </div>
                        <div class="m-t-xs">
                           <div class="row m-t-lg .p-b-n-lg" id="prodlcgroup_box">
            ...
            <div class="col-lg-3">
                <div class="hpanel stats">
                    <div class="panel-body h-200">
                        <div class="stats-title pull-left">
                            <h3><span id = 'rightbox_fxn'><span></h3>
                        </div>
                        <div class="stats-icon pull-right">
                        ...
                        <div class="clearfix"></div>
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="prodlcscorechart_box">
                            
                            </div>
                        </div>
                        <div class="m-t-xs">

                            <div class="row m-t-lg .p-b-n-lg" id="prodlcscore_box"></div>
                        </div>
                    </div>
                    <div class="panel-footer">
...
<!-- Modals ProdLC-->
	...
	<!-- Modals Cross Modular-->
	
	<div class="modal fade" id="crossmodular_modal" tabindex="-1" role="dialog"  aria-hidden="true">
	    <div class="modal-dialog modal-lg verylargemodal">
	        <div class="modal-content">
	            <div class="color-line"></div>
				                    ...
				                    <div class="panel-body">
				                        <div class="row">
				                            <div class="col-md-3 text-center">                            	
												...
												<div class="row m-t-sm m-l-md" id="cmoverallscore_box_modalwg"></div>
												<div class="row">
							                        <div class="stats-title text-center m-l-md">
					                            		<span id="cmtotalsurveys"></span>
					                        		</div>
						                        </div>
						                        <div class="row">
							                       										                
										                <ul class="nav nav-second-level m-t-lg">
										                	<li>
										                		<label class='col-sm-2 control-label m-t'>View</label>
										                		<div class='col-sm-10 '>
											                		<select class="form-control m-b" name="filter_view_cm" id="filter_view_cm">
														                <option value="1">Month</option>
														                <option value="2">Week</option>
														                <option value="3">Quarter</option>
														                <option value="4">Year</option>
													        ...
													        <li>			        	
													        		<label class='col-sm-2 control-label'>Year</label>
													        		<div class='col-sm-10'>
													        			<select class='form-control m-b' name='yearno_cm' id='yearno_cm' ></select>
													        		</div>			        	   
													        </li>
													        <li id="filter_freq_cm">
										                			<label class='col-sm-2 control-label' id="freqno_label_cm"></label>
										                			<div class='col-sm-10'>
										                				<select class='form-control m-b' name='freqno_cm' id='freqno_cm'></select>
										                			</div>
													        </li>
										                </ul>
				                            ...
				                            <div class="col-md-9">				                                
				                                <div class="row">
					                                ...
					                                <div class="flot-chart" id="cmoverallscorechart_box_modalwg"  style="height: 160px">
				                                ...
				                                <div class="row">
												        ...
												        <div class="hpanel">
												            ...
												            <div class="panel-body">
												                <div class="table-responsive">
													                <h4>Timeliness Buckets</h4>
								               						<table id='Cmtp2timebucket_modalwg' class="table table-striped dt_rowpaddinfg hover cell-border row-border"></table>
																</div>				
												            </div>
	...
	<div class="modal fade" id="SppRawData" tabindex="1" role="dialog"  aria-hidden="true">
                   ...
                   <div class="modal-header custom_modal_header">
						<div class="row">
							<div class="col-md-10">
								...
								<div class="col-md-2" id="filter_workgroup">			                		
			                		<div class="m-t-md">
        ...
        <div class="modal fade" id="rawdataverbatim" tabindex="2" role="dialog"  aria-hidden="true">
...
<script src="modules/scoregenwg.js"></script>
